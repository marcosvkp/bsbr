            ...
            [
                ...
                ft.Container(
                    content=ft.Row(
                        ...
                        alignment=ft.MainAxisAlignment.CENTER, spacing=10, wrap=True, run_spacing=10
                    ),
                    width=600 # Limita a largura para forçar wrap apenas em telas pequenas
                )
            ],
